    ...
    <div className="pb-16">
      ...
      <section className="py-20">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-display font-bold text-foreground mb-8">আমাদের গল্প</h2>

              <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                <p>
                  <span className="text-primary font-semibold">Pixelcraft Studio</span> হলো একটি ডিজিটাল এডুকেশন
                  প্ল্যাটফর্ম যেখানে আমরা{" "}
                  <span className="text-foreground font-medium">AI, প্রম্পট ইঞ্জিনিয়ারিং, এবং ডিজিটাল স্কিল</span>{" "}
                  নিয়ে বাংলায় কন্টেন্ট তৈরি করি।
                </p>

                <p>
                  আমাদের প্রথম প্রোডাক্ট <span className="text-primary font-semibold">"AI Prompt Mastery"</span>{" "}
                  ইবুক—যেখানে ChatGPT, ইমেজ জেনারেশন, ভিডিও তৈরি, এবং AI দিয়ে ফ্রিল্যান্সিং এর সম্পূর্ণ গাইড দেওয়া
                  হয়েছে।
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="text-center">
                ...
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-6">
                  বাংলা ইবুক যেখানে AI এর A টু Z শেখানো হয়েছে
                </p>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container-custom">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-display font-bold text-foreground">আমাদের বৈশিষ্ট্য</h2>
          </motion.div>
      ...
      <section className="py-20">
        <div className="container-custom">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-display font-bold text-foreground mb-4">আমরা যা করতে চাই</h2>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-br from-primary via-primary/90 to-primary/80 text-primary-foreground relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-6">AI শেখার যাত্রা শুরু করুন আজই</h2>
